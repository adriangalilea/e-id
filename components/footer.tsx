...
export default function Footer({ children }: { children?: React.ReactNode }) {
  return (
    <footer className="fixed bottom-0 flex justify-between border-t-[0.1px] border-black/15 bg-zinc-50/60 text-zinc-500 shadow-2xl backdrop-blur-2xl dark:border-white/15 dark:bg-zinc-950/60 ">
